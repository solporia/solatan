...
import sty from "./PlasmicButton.module.css"; // plasmic-import: mhmwD0DOLyew/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: DhvpZ9RV66x0/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: k6o0nvn_n3L-/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__yaYSs)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__piQz6)}
                role={"img"}
              />
            ),
